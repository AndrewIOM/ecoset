...
const models: TsoaRoute.Models = {
    ...
    "VariableDTO": {
        ...
        "properties": {
            ...
            "Methods": {"dataType":"array","array":{"dataType":"refObject","ref":"MethodDTO"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/api/v1/Data/status/:packageId',
            ...(fetchMiddlewares<RequestHandler>(DataPackageController)),
            ...(fetchMiddlewares<RequestHandler>(DataPackageController.prototype.status)),

            function DataPackageController_status(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/api/v1/Data/submit',
            ...(fetchMiddlewares<RequestHandler>(DataPackageController)),
            ...(fetchMiddlewares<RequestHandler>(DataPackageController.prototype.submit)),

            function DataPackageController_submit(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/api/v1/Data/list',
            ...(fetchMiddlewares<RequestHandler>(DataPackageController)),
            ...(fetchMiddlewares<RequestHandler>(DataPackageController.prototype.list)),

            function DataPackageController_list(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/api/v1/Data/fetch/:packageId',
            ...(fetchMiddlewares<RequestHandler>(DataPackageController)),
            ...(fetchMiddlewares<RequestHandler>(DataPackageController.prototype.fetch)),

            function DataPackageController_fetch(request: any, response: any, next: any) {
            const args = {
                    packageId: {"in":"path","name":"packageId","required":true,"dataType":"string"},
            };
